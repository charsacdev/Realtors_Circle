...
class Dashboard extends Component
{
    ...
    public function mount()
    {
        ...
        $this->customerCount = count($this->user->customers);
        ...
        $this->customerPercentageChange = percentageChange('customers', null, null, $this->user->id, 'user_id');
        ...
        $this->customerData = $this->chartData['customerData'];
    ...
    public function fetchData($filter, $date = null)
    {
        ...
        if($date)
        {
            for ($i = 0; $i < 24; $i++) {
                ...
                $customerData[] = Customer::where('user_id', $user_id)->whereBetween('created_at', [$start, $end])->count();
