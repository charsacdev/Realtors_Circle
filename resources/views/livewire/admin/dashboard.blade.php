            ...
            <div class="row">
                ...
                <div class="col-lg-3 col-sm-6 mb-4">
                    <div class="dsb-card border">
                        ...
                        <div class="dsb-card-footer">
                            <small><span class="primary-color">10%</span> increase compare to
                                last month </small>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 col-sm-6 mb-4">
                    <div class="dsb-card border">
                        ...
                        <div class="dsb-card-footer">
                            <small><span class="text-danger">7%</span> increase compare to last
                                month </small>
                        </div>
                    </div>
                </div>
                    ...
                    <div
                        ...
                        <div class="chart-filter">
                            ...
                            <div>
                                ...
                                <input type="text" class="custom-select" style="width: 100px;"
                                    data-provide="datepicker" placeholder="Select dates">
                            </div>
                        </div>
                    </div>
                        ...
                        <table class="table dt_datatable" id="dashboard-table">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>2 Plots of Land @ Abakaliki</td>
                                    <td>+2348256746633</td>
