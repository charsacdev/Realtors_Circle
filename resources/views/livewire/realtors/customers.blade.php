<div>
    <main>
        <div class="container">
            ...
            <div class="text-end">
                <a href="{{ route('realtor.customer.create') }}" class="new-discussion-btn bg-dark order-1 order-sm-2 mb-5 mb-sm-0"><img src="asset/img/icons/plus-icon.png" alt=""> &nbsp; Add New Customer</a>
            </div>
             <div class="row mt-4">
                  <div class="col-12">
                    ...
                    <div class="modal-content">
                        <div class="modal-body rounded">
                            ...
                            <h3 class="text-center mb-4">{{ "$customer->first_name $customer->last_name" }}</h3>
                                <a href="{{ route('realtor.customer-details', $customer->id) }}" class="new-discussion-btn btn-success d-block w-100 mb-3">View</a>
