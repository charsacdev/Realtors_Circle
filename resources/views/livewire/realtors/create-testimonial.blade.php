<div>
    ...
    <main>
        <div class="container">
             <form wire:submit.prevent="createTestimonial" enctype="multipart/form-data">
                @csrf
                  <div class="row my-5">
                               ...
                               <div class="col-md-5 mt-5">
                                   <div class="profile-ctn" style="height: auto;">
                                       <div class="img" id="imagePreview">
                                        ...
                                        @endif
                                           <img class="@if($client_image) d-none @endif" src="{{asset('realtor-dashboard/asset/img/user-img.png')}}" alt="">
                                       </div>
                               ...
                               <div class="col-md-7 mt-5">
                                   <div class="profile-details">
                                           <div class="row" style="border-bottom: 2px dashed #cccccc;">
                                               <div class="col-sm-6 mb-4">
                                                   <div class="form-group">
                                                       ...
                                                       <input type="text" id="client_name" wire:model="form.client_name"  class="form-control" style="background:transparent">
                                                   </div>
                                                   <div>
                                           ...
                                           <div class="form-group counter-container my-4">
                                                ...
                                                <textarea wire:model="form.client_review" class="form-control text-source" rows="5"></textarea>
                                                <div class="text-end">
                                                  <small class="primary-color">
                                                     <span class="entered-text primary-color">0</span>/<span class="total-text primary-color">1000</span> words
                                                </small>
                                                </div>
                                                <div>
                                           ...
                                           <div class="d-flex align-items-center justify-content-between mt-4">
                                                <a href="{{ route('realtor.profile') }}" class="new-discussion-btn outline-success px-5">Back</a>
