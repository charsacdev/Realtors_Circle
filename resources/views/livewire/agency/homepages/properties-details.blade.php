<div>
    ...
    @include('agency.homepages.includes.header', ['property_details_hero' => true, 'videos' => $videos, 'first_image' => $first_image])
    <main>
        <section>
          <div class="container">
            <div class="row">
            ...
            <div class="row mb-5">
                ...
                <div class="col-lg-4 col-md-6  mb-4">
                    <div class="property-recard">
                        ...
                        <a href="{{ route('agency-property-description', ['slug' => $agency->slug, 'realtor_slug' => $user->slug, 'property_id' => $property->id]) }}" class="prop-btn mt-4"> More Details</a>
                    </div>
                </div>
            @endforeach
            </div>
