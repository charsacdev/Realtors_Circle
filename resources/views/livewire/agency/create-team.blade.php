                               ...
                               <div class="col-md-5 mt-5">
                                   <div class="profile-ctn" style="height: auto;">
                                       <div class="img" id="imagePreview">
                                        @if ($team_image)
                                            <img src="{{ $team_image->temporaryUrl() }}" alt="">
                                            
                                        @endif
                                           <img class="@if($team_image) d-none @endif" src="{{asset('realtor-dashboard/asset/img/user-img.png')}}" alt="">
                                       </div>
                                       <div wire:loading wire:target="team_image">Uploading...</div>
                                       <div>
                                            @error('form.team_image') <span class="error">{{ $message }}</span> @enderror
                                      </div>
                                       <div>
                                           <input type="file" class="d-none" wire:model="team_image" name="profile_picture" id="profile_picture">
