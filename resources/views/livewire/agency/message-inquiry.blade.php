               ...
               <div class="row my-5">
                    <div class="col-sm-6 mb-4">
                         <div class="form-group">
                              ...
                              <input type="text" value="{{ $inquiry->first_name }}" id="" class="form-control">
                         </div>
                    </div>
                    <div class="col-sm-6 mb-4">
                         <div class="form-group">
                              <label for="">Last Name</label>
                              <input type="text" value="{{ $inquiry->last_name }}" id="" class="form-control">
                         </div>
                    </div>
                    <div class="col-sm-6 mb-4">
                         <div class="form-group">
                              <label for="">Email Address</label>
                              <input type="text" value="{{ $inquiry->email }}" id="" class="form-control">
                         </div>
                    </div>
                    <div class="col-sm-6 mb-4">
                         <div class="form-group">
                              <label for="">Phone Number</label>
                              <input type="text" value="{{ $inquiry->phone_number }}" id="" class="form-control">
                         </div>
                    </div>
                    <div class="col-12 mb-4 pb-5" style="border-bottom: 2px dashed #ccc;">
                         <div class="form-group">
                              <label for="">Message</label>
                              <textarea rows="5" id="" class="form-control">{{ $inquiry->reason }}</textarea>
                         </div>
                    </div>
                    <div class="col-12 mb-4">
                         <div class="form-group">
                              ...
                              <select name="" id="" class="form-control">
                               ...
                               <option value="{{ $inquiry->email }}">Email</option>
                               <option value="{{ $inquiry->phone_number }}">Whatsapp</option>
                              </select>
                         </div>
                    </div>
