<div>
    ...
    <main>
        <div class="container">
             <form wire:submit.prevent="updateColors" class="mb-5">
               @csrf
                  <div class="row">
                    <h4 class="form-title mt-3 mb-2">Update Color Palette</h4>
                    <small class="mb-4 text-info">(Click on color to pick new color)</small>
                       ...
                       <div class="col-sm-6">
                         ...
                         <select name="" wire:model="form.is_active" class="form-control" id="">
                              ...
                              <option {{ $is_active != 1 ? 'selected' : '' }} value="0">Inactive</option>
                         </select>
                         <div>
