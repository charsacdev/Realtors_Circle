                ...
                <div class="row align-items-center" id="signup-container">
                  ...
                  <div class="col-md-7 col-lg-8">
                    <form action="" class="reg-form">
                      ...
                      <div class="mb-5">
                        <span>Already have account? </span> <a href="signin" id="load-signin" class="primary-text">Sign in</a>
                      </div>
      
                      <div class="form-group mb-5">
                        <input type="text" class="w-100" name="" placeholder="Company Name" id="">
                      </div>

                      <div class="form-group mb-5">
                        <input type="email" class="w-100" name="" placeholder="Email Address" id="">
                      </div>
                      <div class="input-group i-group-div mb-5">
