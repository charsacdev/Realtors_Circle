              ...
              <div class="col-lg-10 position-relative">
                ...
                <div class="row align-items-center" id="signup-container">
                  ...
                  <div class="col-md-7 col-lg-8">
                    <form class="reg-form" wire:submit.prevent="register" method="POST">
                      @csrf
                      <h3 class="form-title">Create an account(Agency)</h3>
                      ...
                      <div class="form-group mb-5">
                        <input type="text" class="w-100" wire:model="form.company_name" placeholder="Company Name" id="">
                        <div>
                      ...
                      <div class="form-group mb-5">
                        <input type="text" class="w-100" wire:model="form.email" placeholder="Email Address" id="">
                        <div>
                          @error('form.email') <span class="error">{{ $message }}</span> @enderror
                        </div>
                      </div>
                      <div class="input-group i-group-div">
                            <input type="password" name="password" wire:model="form.password" id="password" name="password" class="form-control shadow-none psw_input" placeholder="Password">
